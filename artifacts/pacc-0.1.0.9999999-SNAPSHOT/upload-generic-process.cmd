...
java "-Dpacc.location=%PACC_LOCATION%" "-Dpacc.program=%PACC_PROGRAM%" -cp "%PACC_LOCATION%\lib\pacc-0.1.0.9999999-SNAPSHOT.jar" ucd.pacc.main.UploadGenericProcessMain %*
